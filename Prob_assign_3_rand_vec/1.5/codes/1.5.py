...
import sys
sys.path.insert(0,'/home/sreeja/Prob_assign_3/CoordGeo')
...
print(f"m,n,c of bisector of A : {m_a},{n_a},{c_a}")
print(f"m,n,c of bisector of B : {m_b},{n_b},{c_b}")
print(f"m,n,c of bisector of C : {m_c},{n_c},{c_c}")
